package ru.mirea.kucheras.osmmaps;
...
import ru.mirea.kucheras.osmmaps.databinding.ActivityMainBinding;
...
// Выполняется запрос к пользователь на получение необходимых разрешений
        ...
        marker.setPosition(new GeoPoint(55.738596, 37.411014));
        marker.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"ТЦ Кунцево плаза",
        ...
        marker2.setPosition(new GeoPoint(55.790491, 37.531373));
        marker2.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"ТЦ АвиаПарк",
                        Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        marker2.setTitle("ТЦ АвиаПарк");


        Marker marker3 = new Marker(mapView);
        marker3.setPosition(new GeoPoint(55.720306, 37.379831));
        marker3.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"ТЦ Vegas",
                        Toast.LENGTH_SHORT).show();
                return true;
            }
        });
